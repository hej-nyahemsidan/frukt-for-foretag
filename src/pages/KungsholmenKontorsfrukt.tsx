...
import { MapPin, Clock, Shield, Building, Landmark, CheckCircle } from 'lucide-react';
import { Link } from 'react-router-dom';

const KungsholmenKontorsfrukt = () => {
  const governmentProducts = [
    {
      name: 'Myndighets Fruktkorg',
      description: 'Anpassad för offentlig sektor och myndigheter',
      features: ['Upphandlingsanpassad', 'Miljöcertifierad', 'Långa avtalsperioder'],
      price: 'Från 385 kr/vecka'
    },
    {
      name: 'Kontors Standard Plus',
      description: 'Perfekt för privata företag på Kungsholmen',
      features: ['Flexibla leveranstider', 'Säsongsanpassning', 'Kvalitetsgaranti'],
      price: 'Från 435 kr/vecka'
    }
  ];

  const kungsholmenAreas = [
    {
      icon: <Shield className="w-6 h-6" />,
      area: 'Polhemsgatan',
      description: 'Myndigheter och offentliga kontor'
    },
    {
      icon: <Building className="w-6 h-6" />,
      area: 'Fleminggatan',
      description: 'Privata företag och konsultbolag'
    },
    {
      icon: <Landmark className="w-6 h-6" />,
      area: 'Stadshagen',
      description: 'Moderna kontorskomplex'
    }
  ];
      ...
      <main>
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-charcoal mb-4">
                Anpassade Lösningar för Kungsholmen
              </h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Vi förstår både offentlig sektor och privata företags behov på Kungsholmen 
                och erbjuder skräddarsydda fruktleveranser.
              </p>
            </div>

            <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto mb-12">
              {governmentProducts.map((product, index) => (
                <Card key={index} className="hover:shadow-lg transition-shadow border-2 hover:border-secondary/30 bg-gradient-to-br from-white to-secondary/5">
                  <CardHeader>
                    <div className="flex items-center mb-2">
                      ...
                      <span className="text-xs font-semibold text-secondary uppercase tracking-wide">Professionell</span>
                    </div>
        ...
        <section className="py-16 bg-gradient-to-br from-secondary/5 to-primary/10">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-charcoal mb-4">
                Vi levererar till hela Kungsholmen
              </h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Från Polhemsgatan till Stadshagen - vi känner Kungsholmens särskilda behov 
                och levererar därefter.
              </p>
            </div>

            <div className="grid md:grid-cols-3 gap-8">
              {kungsholmenAreas.map((area, index) => (
