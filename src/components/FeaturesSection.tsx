...
const FeaturesSection = () => {
  ...
  return (
    <section className="bg-gradient-to-br from-sky-100 via-sky-50 to-blue-100/60 py-20 sm:py-24 px-4 sm:px-8 overflow-hidden relative">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/3 w-64 h-64 bg-sky-300/20 rounded-full blur-3xl"></div>
      </div>
        ...
        <div className="space-y-12">
          ...
          <div className="text-center">
            ...
            <p className="text-slate-600 mt-2 max-w-2xl mx-auto text-sm sm:text-base">
              Se priser och leveransområden för{' '}
              <Link to="/fruktkorg-stockholm" className="text-primary underline hover:text-primary-dark font-semibold">fruktkorg Stockholm</Link>{' '}
              eller läs:{' '}
