  ...
  return (
    <>
      <div className="mb-4 p-3 bg-red-50 border border-red-200 rounded-lg text-center">
        <span className="text-red-600 font-semibold text-sm">🎉 Erbjudande i {new Date().toLocaleDateString("sv-SE", { month: "long" }).replace(/^./, c => c.toUpperCase())} – 8% rabatt på alla fruktkorgar!</span>
      </div>
        ...
        {fruktkorgar.map((product) => {
          ...
          return (
            ...
            >
              ...
              {product.name.toLowerCase().includes('banan') && (
